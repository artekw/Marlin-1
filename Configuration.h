...
#define STRING_CONFIG_H_AUTHOR "(artek, Delta 3DR)" // Who made the changes.
...
#define PID_MAX 190 //255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#ifdef PIDTEMP
